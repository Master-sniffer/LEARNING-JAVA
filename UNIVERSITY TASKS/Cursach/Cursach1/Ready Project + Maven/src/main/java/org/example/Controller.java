...
import org.example.animations.Otletaet;
...
public class Controller {
    ...
    void OldScreen(ActionEvent event) {
        ...
        try{
            String musicFile = "src/main/resources/org/example/my-movie-6_0RlWMvM.mp3";
    ...
    void RegScreen(ActionEvent event) {
        ...
        String musicFile = "src/main/resources/org/example/woo_htcxajK.mp3";
    ...
    private void loginuser(String logintext, String loginPassword) {
        ...
        System.out.println("Noice job, nigga");
            try{
                ...
                String musicFile = "src/main/resources/org/example/deep-dark-fantasies.mp3";
