...
public class change_grimerka {
    ...
    void make(ActionEvent event) {
        if (!grimer.getText().toString().equals("") && (!data.getText().toString().equals("") || !repa.getText().toString().equals("") || !vistup.getText().toString().equals("") || !scene.getText().toString().equals("") || !password.getText().toString().equals("") || !login.getText().toString().equals(""))){
            ...
            database.ChangeSet(theatre , "grimer",grimer.getText().toString());
        } else {
    ...
    void initialize() {
        ...
        assert password != null : "fx:id=\"password\" was not injected: check your FXML file 'change_grimerka.fxml'.";
        assert login != null : "fx:id=\"login\" was not injected: check your FXML file 'change_grimerka.fxml'.";
        ...
        assert scene != null : "fx:id=\"scene\" was not injected: check your FXML file 'change_grimerka.fxml'.";
        assert data != null : "fx:id=\"data\" was not injected: check your FXML file 'change_grimerka.fxml'.";
        assert vistup != null : "fx:id=\"vistup\" was not injected: check your FXML file 'change_grimerka.fxml'.";
        assert repa != null : "fx:id=\"repa\" was not injected: check your FXML file 'change_grimerka.fxml'.";
